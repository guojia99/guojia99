...
- 专业学历： `本科` / `广东科技学院 计算机系` /  `信息管理与信息系统` / `2017.9~2021.6`

- 专业学科:  `数据挖掘` / `机器学习` / `oracle` / `数据统计与数据提取`
...
## 技能清单
- <img align="left" src="https://img.shields.io/badge/-Golang-333333?style=flat&logo=go&logoColor=007396" alt="Golang" />
  - 熟练使用go所需基础库及常见第三方库
...
- <img align="left" src="https://img.shields.io/badge/-Python-333333?style=flat&logo=python&logoColor=007396" alt="Python" />
  - 数量掌握`python`所需的语法、基础库和第三方库
...
- <img align="left" src="https://img.shields.io/badge/-DataBase-333333?style=flat&logo=mysql&logoColor=FCC624" alt="Mysql" />
  - **关系型**: `mysql` / `sqlite` / `oracle`
  - **非关系型**: `redis` / `mongo` /  `etcd`
  - **时序**： `influxDb`
- <img align="left" src="https://img.shields.io/badge/-TypeScript-333333?style=flat&logo=typescript&logoColor=FCC624" alt="TS" />
  - 掌握`Typescript`及有相关项目开发经验。
  - **框架**： `react` / `ant-design` / `bootstrap` / `JQuery`
- <img align="left" src="https://img.shields.io/badge/-Linux-333333?style=flat&logo=Linux&logoColor=FCC624" alt="Linux" />
  - `k8s`生态、虚拟机、容器等相关工具使用和调试。
  - 图像相关组成知识、科学计算、图像视觉处理算法和实际落地实现。
  - 拥有数据制图、爬虫、数据分析能力。
  - 一定AI模型训练、开发、部署等开发调试经验。
  - 各类命令行使用, `shell`脚本编写, 文件系统维护和`linux`开发经验。
  - `ffmpeg / 海康摄像头 / v4l2 / vlc` 等视频、摄像使用与调度。
...
#### 工作描述
- 云端微服务开发和`PaaS`服务重构工作，开发部分`SaaS`服务。
- 边缘端开发和维护工作，开发边缘业务程序、插件、脚本、工具等， 使业务数据上云，对接云端 `PaaS`服务。
- 图像、视觉类程序开发，`AI`算法调度工作， 开发多平台脚本。
- 运维相关脚本开发， 基于业务做相应的自动化测试、压力测试等。
...
- `edgetool 边缘管理工具`
  ...
  - `项目成果`: 简化运维流程和边缘测试流程, 节省80%以上运维时间。
...
- 广州机智云物联网科技有限公司2021年度`优秀新人奖`, 2022年度`创新突破奖`。
- 中国高校计算机大赛2020年网络技术挑战赛决赛`全国三等奖`, 初赛`华南赛区第二名`。
- 广东科技学院2020年度`优秀一等奖学金`,三年`全国大学生数学建模竞赛`广东省奖项`一等奖`,  广东科技学院`计算机竞赛`连续三年个人冠军、连续两年团体冠军。
